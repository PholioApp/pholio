...
serve(async (req) => {
  ...
  // Use service role to bypass RLS for ad creation after payment verification
  ...
  try {
    console.log("Starting ad payment verification");
    ...
    console.log("Payment verified, creating ad record");
